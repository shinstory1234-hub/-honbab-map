...
const REGIONS = [
  ...
  { name: '수원',   lat: [37.220, 37.330], lng: [126.950, 127.080] },
  { name: '용인',   lat: [37.190, 37.410], lng: [127.060, 127.320] },
  { name: '화성',   lat: [37.100, 37.280], lng: [126.740, 127.100] },
  { name: '안양',   lat: [37.360, 37.430], lng: [126.880, 126.990] },
  { name: '안산',   lat: [37.290, 37.390], lng: [126.700, 126.890] },
  { name: '의정부', lat: [37.610, 37.780], lng: [126.990, 127.130] },
  { name: '남양주', lat: [37.530, 37.690], lng: [127.080, 127.310] },
  { name: '평택',   lat: [36.940, 37.100], lng: [126.940, 127.130] },
  { name: '시흥',   lat: [37.340, 37.430], lng: [126.700, 126.830] },
  // ── 충청 ─────────────────────────────────────────
  ...
  { name: '울산',   lat: [35.440, 35.620], lng: [129.180, 129.390] },
  { name: '창원',   lat: [35.150, 35.320], lng: [128.490, 128.780] },
]
